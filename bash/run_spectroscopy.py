...
CODEPATH = "/home/brandon/software/oceanoptics/seabreeze-3.0.11/SeaBreeze"
LIBPATH = os.path.join(CODEPATH,"lib")
...
while True:
  p = subprocess.Popen([os.path.join(cwd,"seabreeze-util"),"--get-spectrum","--integration-time-us",str(integrate_micros)],cwd=cwd,env={"LD_LIBRARY_PATH": LIBPATH},stdout=subprocess.PIPE)
  p.wait()
