...
def send_inputs_all(device,device2,Vn,Fn,Qn,Yn,Pn,Dn,On):
  """
  Sends input values to the microcontroller to actuate them
  """
  device.reset_input_buffer()
...
#            t_move_dis=time.time()
          ...
          ####################### STEP TEST ########################################
        print('time remaining {:6.2f}'.format(time.time()-t_move_step))
        ...
        send_inputs_all(f,f_move,V,F,Q,Y_pos,Dc,Dsep,O)
        print("Inputs sent!")
        ...
        save_fl.write('{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f}\n'.format(time.time(),Tset,Ts,Ts2,Ts3,P,Imax,O777,O845,N391,He706,sum_int,*U_m,x_pos,y_pos,T_emb,V,P_emb,Prms,D_c,Rdel,Is,q_o,sig,Ip2p,tm_el))
        save_fl.flush()
