  ...
  while True:
    ...
    if time_el < Delta-0.5:
       ...
       # print('averaging inputs...')
        if record:
         save_file.write("{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f}\n".format(time.time(),Ts_i,Is_i,*(Ct.dot(pred).T+Y0).flatten(),*Y,*U.flatten(),*ztar_k,t_sol))  ##X is never referenced!
      #print()
         save_file.flush()
    elif time_el > Delta-0.5:
        k = k + 1
