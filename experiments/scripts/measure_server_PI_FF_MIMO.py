...
#            t_move_now=time.time()
       ...
       # print(len(Ts_2d_out))
        ...
        x_now=NP.linspace(-13*1.44,12*1.44,26)+Y_pos #positions corresponding to current measurement        
        y_now=NP.linspace(13*2,-12*2,26)+X_pos  #positions corresponding to current measurement
