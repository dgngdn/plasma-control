...
COLUMN_YDATA = [18]                    # index of the y-data columns
YLIM = True                            # whether to use specified y-limits (BROKEN)
YMIN = 10                              # y-min for plotting
YMAX = 30                              # y-max for plotting
...
def get_ydata(timepoint,ycol):
    try: return float(timepoint[ycol])
    except: pass
