...
VIEW_WINDOW = 1200                 # seconds of data to view at once
...
# data
TOTAL_COLUMNS = 20                     # total number of columns expected per datapoint
COLUMN_YDATA = [9,10,11]                # index of the y-data columns
YSCALING = { 9: (100/10.), 10: (100/24.), 11: (100/2.5) }

YLIM = True
YMIN = -5                               # y-min for plotting
YMAX = 105                             # y-max for plotting
...
plotlines = [pyplot.plot(ydata[n],marker='o',markersize=4,linestyle='-',markeredgewidth=0.0)[0]
                for n in range(NUM_YCOLS)]

if YLIM: pyplot.ylim([YMIN,YMAX])
